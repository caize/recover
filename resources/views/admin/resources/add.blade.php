...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li><a href="javascript:;">{!! trans('admin.resources.index') !!}</a></li>
        <li class="active">{!! trans('admin.resources.store') !!}</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">{!! trans('admin.resources.store') !!}</h4>
                </div>
