                        ...
                        <div id="data-table_wrapper" class="dataTables_wrapper no-footer">
                            <div class="dataTables_length" id="data-table_length">
                                <label>显示
                                    ...
                                    <a href="{{url('admin/article/create')}}"  class="btn btn-primary m-r-5 m-b-5" style="height: 32px;margin-top: 4px;">文章添加</a>
                                    @endpermission
                                </label>
                            </div>
...
<script src="/js/admin/article/article.js"></script> @endsection