...
<div id="content" class="content">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="#general-tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-fw fa-cogs"></i> <span class="hidden-xs">{!! trans('admin.system.config.web') !!}</span></a></li>
