...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active"><?php echo trans('admin.resources.category.index'); ?></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
        ...
        <div class="col-md-6 ui-sortable">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title"><?php echo trans('admin.resources.category.index'); ?></h4>
                </div>
                            ...
                            <li class="dd-item dd3-item" data-id="{{vo.id}}" v-for="vo in list">
                                ...
                                <div class="dd3-content">{{vo.name}}
                                    <div class="pull-right action-buttons">
                                        <?php if (\Entrust::can(('admin.resources.category.store'))) : ?>
                                        ...
                                        <?php if (\Entrust::can(('admin.resources.category.update'))) : ?>
                                        ...
                                        <?php endif; // Entrust::can ?>
                                        <?php if (\Entrust::can(('admin.resources.category.destroy'))) : ?>
        ...
        <div class="col-md-6 ui-sortable">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title"><?php echo trans('admin.resources.category.add'); ?></h4>
                </div>
                <div class="panel-body">
            ...
            methods: {
                ...
                destroyCate: function(id){
                    layer.confirm('确认删除分类', {icon: 1, title:'删除分类'}, function(index){
                        vn.$http.delete("<?php echo e(url('admin/resources/category')); ?>/"+id)
                ...
                createCate: function (data){
                    this.$http.post("<?php echo e(url('/admin/resources/category')); ?>",data)
                    .then(function (response){
                        this.callback(response);
                    }, function (response) {
                ...
                updateCate: function (data){
                    this.$http.put("<?php echo e(url('/admin/resources/category')); ?>/"+data.id,data).then(function (response){
                        this.callback(response);
                    }, function (response) {
                        console.log(response)
                    });
                 ...
                 */
                cateList: function(){
                    this.$http.post("<?php echo e(url('/admin/resources/category/index')); ?>").then(function (response){
