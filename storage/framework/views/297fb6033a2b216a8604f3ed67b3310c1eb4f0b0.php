...
<div id="content" class="content webConfig" >
    ...
    <ul class="nav nav-tabs">
        <li class="active" @click="configActive(1)"><a href="#general-tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-fw fa-cogs"></i> <span class="hidden-xs"><?php echo trans('admin.system.config.web'); ?></span></a></li>
                        ...
                        <div class="form-group" v-for="c in config">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                      ...
                                      <img v-else src="<?php echo e(asset('assets/img/no-image.png')); ?>" alt="" id="{{c.code}}"/>
                                      </div>
            ...
            <form class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" novalidate="">
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8">
                        ...
                        <?php /* <ul class="parsley-errors-list filled" id="parsley-id-3227"><li class="parsley-required">This value is required.</li></ul> */ ?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8">
                        ...
                        <?php /* <ul class="parsley-errors-list filled" id="parsley-id-0512"><li class="parsley-required">This value is required.</li></ul> */ ?>
                    </div>
                </div>
                <div class="form-group">
    ...
    var vn = new Vue({
        ...
        methods: {
            ...
            configActive: function (id){
                var data = {group:id};
                this.$http.post("<?php echo e(url('admin/config/index')); ?>",data).then(function (response){
            ...
            editConfig:function(){
                ...
                this.$http.post("<?php echo e(url('admin/config')); ?>",this.con).then(function (response){
