        ...
        new Vue({
            ...
            methods: {
                ...
                createNode: function (data){
                    this.$http.post("<?php echo e(url('/admin/role')); ?>",data).then(function (response){
                        ...
                        if(response.data.code == 200){
                            ...
                            setTimeout(function(){
                                layer.close(ii);
                                window.location.href = "<?php echo e(url('/admin/role/index')); ?>";
                            }, 3000);
                        }
                    }, function (response) {
                ...
                updateNode: function (data){
                    this.$http.put("<?php echo e(url('/admin/role/')); ?>/"+data.id,data).then(function (response){
                        if(response.data.code == 400){
                            this.msg = response.data.message
                        }
                        if(response.data.code == 422){
