        ...
        new Vue({
            ...
            methods: {
                ...
                createUser: function (data){
                    this.$http.post("<?php echo e(url('/admin/user')); ?>",data).then(function (response){
                ...
                updateUser: function (data){
                    this.$http.put("<?php echo e(url('/admin/user')); ?>/"+data.id,data).then(function (response){
                        if(response.data.code == 400){
                            this.msg = response.data.message
                        }
                        if(response.data.code == 422){
